           ...
           <nav class="navbar-default navbar-side" role="navigation">
               <div class="sidebar-collapse">
                   <ul class="nav" id="main-menu">
                       ...
                       <li>
                           <a href="<?= base_url('home/poly') ?>"><i class="fa fa-book"></i>Pemetaan (Polygon)</a>
                       </li>
                       <li>
                           <a href="<?= base_url() ?>home/tampil"><i class="fa fa-table"></i>Data Gunung </a>
                       </li>
                       <li>
                           <a href="<?= base_url() ?>home/tampil_poly"><i class="fa fa-table"></i>Data Gunung (Polygon)</a>
                       </li>
                       <?php if ($this->session->userdata('username') <> "") { ?>
                           ...
                           <li>
                               <a href="<?= base_url() ?>home/input_poly"><i class="fa fa-plus"></i>Input Data Polygon</a>
                           </li>
                       <?php } ?>
                       <!-- <li>
